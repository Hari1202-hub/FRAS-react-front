        ...
        <DialogContent className="sm:max-w-[850px] max-h-[85vh] overflow-y-auto" aria-describedby={undefined}>
          ...
          <Tabs defaultValue="general" className="w-full">
            ...
            <TabsContent value="general" className="space-y-6">
              ...
              {employee.hasOwnProperty("face_enrolled") && (
                <div>
                  <h4 className="text-sm font-medium text-gray-500 mb-3">
                    FACE ENROLLMENT
                  </h4>
                  <div className="flex items-center justify-between space-x-2">
                    ...
                    >
                      {faceEnrollment ? "Enrolled" : "Not Enrolled"}
                    </Badge>
                    {employee.face_enrolled && (
                      <p className="text-sm text-gray-500">
                        Last Updated:{" "}
                        {faceEnrollment?.updated_at
                          ? format(
                              new Date(faceEnrollment.updated_at),
                              "yyyy-MM-dd",
                            )
                          : "-"}
                      </p>
              ...
              <div className="flex justify-end mb-2">
                <Button className="p-2" onClick={() => handleProjectView()}>
                  Add Project
                </Button>
              </div>
              <h4 className="text-sm font-medium text-gray-500 mb-3">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {assignedProjects.map((record, index) => (
                      <tr key={index}>
                        ...
                        <td className="px-4 py-3  text-sm text-gray-900">
                          {record.project?.isactive ? "Active" : "Inactive"}
                        </td>
                        <td className="px-4 py-3  text-sm text-gray-900">
                          <div className="flex items-center space-x-3">
                            <Edit
                              ...
                              onClick={() =>
                                handleEditAssignedProject(record.id)
                              }
                            />
                            <Trash
                              className="h-4 w-4 text-red-500 cursor-pointer"
                              onClick={() =>
                                handleDeleteAssignedProject(record.id)
                              }
                            />
                          </div>
                        </td>
